...
$containerBuilder->autowire(SecondProductSubscriber::class, SecondProductSubscriber::class);
...
$eventBus->subscribe(SecondProductSubscriber::class);

$eventBus->unsubscribe(ProductSubscriber::class);
